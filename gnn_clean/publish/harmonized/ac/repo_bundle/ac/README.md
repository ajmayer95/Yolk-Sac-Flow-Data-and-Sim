# Harmonized AC Release Bundle

This folder contains the lightweight AC results bundle for the harmonized dataset.
...
- The packaged outputs correspond to the harmonized AC run set that used:
  - `lambda_q = 10`
  - `lambda_k = 10`
  - `lambda_delta = 0.1`
  - arterial/venous boundary mode suffix `_all_observed`
  - representative labels `F1`, `B1`, and `K1` for Step 3
