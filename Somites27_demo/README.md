# Somites27 — embryonic yolk-sac flow demo dataset

Self-contained viewer bundle for a stage-27 (HH-27) embryonic chick
...
> **Companion bundle**: stage-21 embryos live at the same Releases page
> as `Somites21_demo.zip`.
...
└── emb1/
    ...
    └── videos/                              ~1.5 GB, 42 of 84 tiles
```

Total unzipped size: ~1.7 GB.  See `LAUNCH.txt` for the exact tile list
