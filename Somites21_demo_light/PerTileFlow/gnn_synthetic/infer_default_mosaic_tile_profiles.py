...
This workflow-local copy profiles distensibility against the synthetic flow
...
Default assumptions:
  ...
  * validated GNN pressure prior from
    ``gnn_edge_dc/masked_edge_validation_15pct``
...
DEFAULT_GNN_PRESSURE_PRIOR_DIR = (
    RESULTS_DIR / "gnn_edge_dc" / "masked_edge_validation_15pct"
)
